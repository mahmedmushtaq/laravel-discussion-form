    ...
    <div id="app">
        ...
        @if(!in_array(request()->path(),['login','register','password/email','password/reset']))
            ...
            <main class="container py-4">
               ...
               <div class="row">
                   <div class="col-md-4">
                       @if(!in_array(request()->path(),['discussion']))
                       <a href="{{route('discussion.index')}}" style="width: 100%; color:white;" class="btn btn-info mb-2">
                          All discussions</a>
                       @endif
                       @auth
                       <a href="{{route('discussion.create')}}" style="width: 100%; color:white;" class="btn btn-info mb-2">
                           Add Discussion</a>
                       @else
                        <a href="{{route('login')}}" style="width: 100%; color:white;" class="btn btn-info mb-2">
                               Sign in to add discussion</a>
                      @endauth
